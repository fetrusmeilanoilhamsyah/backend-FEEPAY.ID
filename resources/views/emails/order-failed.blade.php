...
<head>
    ...
    <title>Pesanan Gagal — FEEPAY.ID</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .body { padding: 32px; }
        .notice { background: #fef2f2; border: 1px solid #fecaca; border-radius: 10px; padding: 16px; margin-bottom: 24px; }
        ...
        .detail-row .value { font-weight: 600; color: #111827; text-align: right; word-break: break-all; }
        .detail-row .value.price { color: #ef4444; font-size: 17px; font-weight: 800; }
        .refund-box { background: #fffbeb; border: 1px solid #fcd34d; border-radius: 10px; padding: 16px; margin-bottom: 24px; }
        .refund-box p { font-size: 13px; color: #92400e; line-height: 1.7; }
        .btn { display: block; width: 100%; padding: 14px; text-align: center; border-radius: 10px; font-weight: 700; font-size: 15px; text-decoration: none; margin-bottom: 12px; }
    ...
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <div class="refund-box">
                <p>
                    ...
                    Jika Anda sudah melakukan pembayaran, dana akan dikembalikan secara otomatis dalam
                    <strong>1–3 hari kerja</strong> melalui metode pembayaran yang Anda gunakan.
                    Jika saldo belum kembali setelah 3 hari kerja, segera hubungi Customer Service kami
                    dengan melampirkan <strong>Order ID</strong> di atas.
                </p>
            </div>

            <a href="https://feepay.web.id" class="btn btn-primary">Coba Pesan Lagi</a>
            {{-- Fix: gunakan config() bukan env() di Blade template --}}
            <a href="https://wa.me/{{ config('feepay.support_whatsapp', '6281234567890') }}" class="btn btn-outline">
        ...
        <div class="footer">
            <p>
                ...
                <a href="https://feepay.web.id" style="color: #6b7280;">feepay.web.id</a>
            </p>
        </div>
    </div>
</body>
