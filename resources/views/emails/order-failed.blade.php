...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header .icon { width: 72px; height: 72px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px; font-size: 32px; color: #fff; }
    ...
    .detail-row { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #e5e7eb; font-size: 14px; }
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <div class="detail-box">
        ...
        <div class="detail-row">
          ...
          <span class="value">{{ $order->target_number }}{{ $order->zone_id ? ' ('.$order->zone_id.')' : '' }}</span>
        </div>
        <div class="detail-row">
      ...
      <div class="refund-box">
        <p>
          ...
          Jika Anda sudah melakukan pembayaran, dana akan dikembalikan secara otomatis dalam <strong>1-3 hari kerja</strong> melalui metode pembayaran yang Anda gunakan.
          Jika saldo belum kembali setelah 3 hari, segera hubungi Customer Service kami dengan melampirkan Order ID di atas.
        </p>
      </div>

      <a href="https://feepay.web.id" class="btn">Coba Pesan Lagi</a>
    ...
    <div class="footer">
      <p>
        ...
        Jangan membalas email ini · <a href="https://feepay.web.id" style="color: #6b7280;">feepay.web.id</a>
      </p>
    </div>
  </div>
</body>
